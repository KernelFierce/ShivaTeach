...
- **Features**:
    1.  **Assignment Submission**: Create a page where students can view assignment details and upload their work to Firebase Storage.
    2.  **Parent Financials**: Build the UI for parents to view and pay invoices and see transaction history.
...
- **Features**:
    1.  **SuperAdmin Tenant Management**: Build the UI for the SuperAdmin to onboard, suspend, and manage organizations.
    2.  **AI-Powered Summaries**: Integrate Genkit to generate automated summaries of student progress or session notes.
